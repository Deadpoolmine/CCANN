...
class AlignedFileReader {
 public:
  ...
  virtual void atomic_truncate(uint64_t size) = 0;
  virtual void sync() = 0;
  virtual uint64_t file_size() = 0;
  virtual void init_dax(uint64_t hint_size) = 0;
  virtual void exit_dax() = 0;
  virtual void *get_dax(uint64_t hint_size, bool init) = 0;
  virtual void put_dax() = 0;
  virtual void flush_dax(void *p, uint64_t size) = 0;
  virtual void barrier_dax() = 0;
  virtual bool check_addr_in_pm(const void *addr) = 0;
  /*
