...
CC_SUPPORT=$3 # 0 by default
PERF=$4 # disabled by default
NUM_THREADS=$5 # 8 by default
WORKLOAD=$6 # bigann-small by default
VECS_PER_STEP=$7 # 5000 by default
NUM_STEPS=$8 # 1 by default
...
if (( ON_PM == 1 )); then
    migrate_to_pm "$INDEX_PATH" "ext4-dax"
