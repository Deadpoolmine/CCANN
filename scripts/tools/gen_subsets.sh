...
# For SIFT-SMALL
# example usage: ./gen_subsets.sh PipeANN /home/data/deadpool/ANN/SIFT-1M/data/sift_groundtruth.bin bigann-20k /home/data/deadpool/ANN/SIFT-1M/data/sift_query.bin 100
