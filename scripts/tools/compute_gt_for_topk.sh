...
# For SIFT-SMALL
# example usage: ./compute_gt_for_topk.sh PipeANN /home/data/deadpool/ANN/SIFT-SMALL/data/siftsmall_base.bin bigann-small /home/data/deadpool/ANN/SIFT-SMALL/data/siftsmall_query.bin 10
